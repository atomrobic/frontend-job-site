...
const Footer = () => {
  return (
    ...
    <div class="px-13 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-2 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="icon" src="https://img.icons8.com/ios/50/lawyer.png" alt="" />
